# Lending Pool User Guide

**Connect your wallet and select a network**

### Connect wallet:

**Step 1.** Open [https://app.trava.finance/pool-list](https://app.trava.finance/pool-list)

**Step 2.** Click _"_**Connect wallet**_"_ on the top right corner as below.

<figure><img src=".gitbook/assets/act 1 - Copy.png" alt="" width="563"><figcaption></figcaption></figure>

**Step 3.** Choose your wallet

<figure><img src=".gitbook/assets/act 2.png" alt="" width="563"><figcaption></figcaption></figure>

**Step 4.** Click _"_**Connect**_"_ on popup window.

<figure><img src=".gitbook/assets/act 3.png" alt="" width="257"><figcaption></figcaption></figure>

### **Select the network:**

**Step 1.** Click the network name on the top-right corner

<figure><img src=".gitbook/assets/act 4 - Copy.png" alt="" width="563"><figcaption></figcaption></figure>
...
<figure><img src=".gitbook/assets/act 6.png" alt="" width="563"><figcaption></figcaption></figure>

**Step 4.** Open an asset detail by clicking dropdown arrow:

<figure><img src=".gitbook/assets/act 7.png" alt="" width="563"><figcaption></figcaption></figure>
...
<figure><img src=".gitbook/assets/act 8.png" alt="" width="336"><figcaption></figcaption></figure>

**Step 6.** Waiting for the deposit processing: approve (if you deposit for the first time or approve amount larger than previous allowance amount) => executing transaction => Transaction succeeded.
...
**Step 6.** Waiting for the withdraw processing: click "Withdraw" button ⇒ executing transaction => Transaction succeeded.
...
**Step 6.** Waiting for the withdraw processing: click "**Borrow**" button ⇒ executing transaction => Transaction succeeded.

**Notes: You need to deposit first before making any borrow.** \
Click **“See transaction detail”** to review your transaction.
...
**Step 6.** Waiting for the withdraw processing: click "**Repay**" button ⇒ executing transaction => Transaction succeeded.
